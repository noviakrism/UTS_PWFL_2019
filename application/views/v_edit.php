			...
			<div class="modal-body">
				...
				<div class="form-group">
				     <label class="control-label col-xs-3" >NIM mahasiswa</label>
                        <div class="col-xs-8">
                            <input name="nim" class="form-control" type="number" placeholder="NIM mahasiswa" value="<?php echo $a['nim']; ?>" readonly required >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama mahasiswa</label>
                        <div class="col-xs-8">
                            <input name="nama_mahasiswa" class="form-control" maxlength="20" type="text" placeholder="Nama mahasiswa" value="<?php echo $a['nama_mahasiswa']; ?>" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="alamat" class="form-control" type="text" maxlength="20" placeholder="Alamat Lengkap" value="<?php echo $a['alamat']; ?>" required readonly>
                        </div>
                    </div>
